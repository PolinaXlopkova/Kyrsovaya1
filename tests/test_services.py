...
def sample_transactions():
    return [
        {"Дата операции": "2023-01-15", "Категория": "Супермаркеты", "Сумма платежа": 5000, "Кешбэк": 50},
        {"Дата операции": "2023-01-20", "Категория": "Рестораны", "Сумма платежа": 3000, "Кешбэк": 150},
        {"Дата операции": "2023-02-01", "Категория": "Транспорт", "Сумма платежа": 2000},
    ]
...
@pytest.mark.parametrize("year,month,expected_count", [(2023, 1, 2), (2023, 2, 1), (2022, 1, 0)])
...
def test_invalid_date_format():
    transactions = [{"Дата операции": "invalid-date", "Категория": "Тест", "Сумма платежа": 100}]
